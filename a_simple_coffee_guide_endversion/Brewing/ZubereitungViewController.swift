...
class ZubereitungViewController: UIViewController {
    ...
    var frenchpress : [String : Any] = ["Name": "FrenchPress", "Image": UIImage(named: "Frenchpress")!, "Quantity": "65g/1l", "Temp": "96°", "Time": "4min", "Tips": ["First Tip", "Second Tip", "Third Tip"], "Complain1": "My Coffee is to bitter", "Complain2": "My coffee tastes sour"]
